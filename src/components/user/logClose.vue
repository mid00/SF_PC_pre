<template>
    <div class="container">
        <div class="login">
    <!-- 背景 -->
            <div class="logTitle"> <span>修改密码</span><img @click="toClose" src="../../assets/close.png"> </div>
    <!-- 手机号码 -->
            <logItem
                class="item"
                type="tel"
    ...
    <!-- 点击登录 -->
            <div class="btn">
                <button @click="handleLogin" :disabled="isClick">提交</button>
            </div>
        </div>
    </div>
</template>
...
// 关闭
        toClose(){
            this.$notify({ title: '消息', message: '退出忘记密码', type: 'warning' });
            this.$emit("tolog", "close");
        },
